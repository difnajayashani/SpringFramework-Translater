...
<fmt:bundle basename="labelNames">
    ...
    <%--    <div class="row">--%>
    <div class="col-sm-10 col-sm-offset-1 " id="tablebody">
        <div class="panel panel-default panel-table" >
            ...
            <div class="panel-body" id="table">
               ...
               <%--panel body for pagination view --%>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button  class="btn btn-danger"  id="btnDelt">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal" role="form" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control selectpicker" name="ugroup" id="ugroup" multiple="multiple" required>
                                        <option>Administrator</option>
                                        <option>Customer Care</option>
                                        <option>Translater</option>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn  btn-primary" id="updatebtn">
                            <fmt:message key="viewuser.modal.updateuser.button"/>
                        </button>
                    </div>
